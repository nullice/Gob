...
let setObjectValueByKeysAsync = (() => {
    ...
    return function setObjectValueByKeysAsync(_x5, _x6, _x7, _x8, _x9, _x10, _x11) {
...
let valuePreFilterAsync = (() => {
    ...
    return function valuePreFilterAsync(_x12, _x13, _x14, _x15, _x16, _x17, _x18) {
        ...
        for (var i = 0; i < orders.length; i++) {
            if (orders[i] != undefined && orders[i].order != undefined) {
                ...
                if (orders[i].order === "new") {
                    ...
                    yield this.$setValue(orders[i].keyPath, orders[i].value, orders[i].who);
...
Gob.prototype.$setValue = (() => {
    var _ref2 = _asyncToGenerator(function* (keyPath, value, who) {
        ...
        if (typeTYP.type(value) === "object" && who != "Gob") {
            var ob = {};
...
Gob.prototype.$newStates = function (object, value, who) {
    ...
    if (typeTYP.type(object) !== "object" && arguments.length >= 2) {
...
Gob.prototype.$util.testAsync = _asyncToGenerator(function* () {
    console.log("step1");

/*!
 * UI-DNA By nullce - nullice.com - ui@nullice.com
...
/* harmony default export */ __webpack_exports__["a"] = (typeTYP);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Gob_js__ = __webpack_require__(148);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Gob", function() { return __WEBPACK_IMPORTED_MODULE_0__Gob_js__["a"]; });
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_define_property__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_Richang_JSEX_typeTYP_js__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_Richang_JSEX_objectOBJ_js__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modes_GobMode_Base_js__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modes_GobMode_VueSupport_js__ = __webpack_require__(151);
...
Gob.prototype.$MODES = { BASE: __WEBPACK_IMPORTED_MODULE_4__modes_GobMode_Base_js__["a" /* default */], VUE_SUPPORT: __WEBPACK_IMPORTED_MODULE_5__modes_GobMode_VueSupport_js__["a" /* default */] };
Gob.prototype.$util = {
...
Gob.prototype.$exec = async function (order) {
    if (__WEBPACK_IMPORTED_MODULE_2__lib_Richang_JSEX_typeTYP_js__["a" /* default */].type(order) === "array") {
        var orders = order;
    } else {
        var orders = [order];
    }
...
Gob.prototype.$setValue = async function (keyPath, value, who) {
    ...
    if (__WEBPACK_IMPORTED_MODULE_2__lib_Richang_JSEX_typeTYP_js__["a" /* default */].type(value) === "object" && who != "Gob") {
        var ob = {};
...
Gob.prototype.$newStates = function (object, value, who) {
    ...
    if (__WEBPACK_IMPORTED_MODULE_2__lib_Richang_JSEX_typeTYP_js__["a" /* default */].type(object) !== "object" && arguments.length >= 2) {
...
function giveSetter(object, keys, index, self, itr, who) {
    for (var key in object) {
        ...
        if (isObject && __WEBPACK_IMPORTED_MODULE_3__lib_Richang_JSEX_objectOBJ_js__["a" /* default */].isEmptyObject(object[key]) !== true) {
            ...
            __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_define_property___default()(itr, key, setterCreators(newKeys.slice(0), self));
            if (typeof self.$_entrails.hooks.newState === "function") {
                self.$_entrails.hooks.newState(itr, key, object[key], keys);
            }

            __WEBPACK_IMPORTED_MODULE_3__lib_Richang_JSEX_objectOBJ_js__["a" /* default */].setObjectValueByNames(self.$_entrails.states, newKeys, object[key]);
...
/* harmony default export */ __webpack_exports__["a"] = (objectOBJ);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_Richang_JSEX_typeTYP_js__ = __webpack_require__(106);
/**
...
var GobMode_VueSupport_init = function (vue) {
    ...
    function init(self) {
        ...
        //为新创建对象在 vue 上添加响应支持
        self.$_entrails.hooks.newState = function (object, key, value, keys) {
            Vue.util.defineReactive(object, key, value);
        };

        self.$_entrails.hooks.OVERWRITE_newStateObject = function (object, key, value, keys) {
...
/* harmony default export */ __webpack_exports__["a"] = (GobMode_VueSupport_init);
...
module.exports = !__webpack_require__(44) && !__webpack_require__(109)(function(){
...
$export($export.S + $export.F * !__webpack_require__(44), 'Object', {defineProperty: __webpack_require__(52).f});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(105), __webpack_require__(372)(module)))
...
//# sourceMappingURL=Gob.webpack.js.map